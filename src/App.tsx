...
const songs: Song[] = [
  ...
  },
  {
    ...
    comment: `M, suna hai aashiq uska
shayar nahi hai.....❤️,
...
Ki aage khada hai koi baaho me araam karane ko 🌹`
  ...
  Wo ladki jis din mere seher aayegi`
    ...
    comment: "M, if our story had a soundtrack, this would be one of the highlights. 🎶"
    },
    {
    id: 11,
    title: "Laal Ishq",
  ...
  comment: "This song paints a picture of love, but you make it come alive for me."
    ...
    Chahoon rehna sada`,
    comment: "M, every time I hear this, I can’t help but think of us dancing under the stars."
    },
  {
    id: 14,
...
comment: "A moving song filled with emotional depth."
    ...
    comment: "M, this reminds me of all the little moments we’ve shared that make life so beautiful."
    },
    {
    id: 24,
    title: "Purani Tape",
        ...
        <div className="relative min-h-screen flex flex-col items-center justify-center px-4 text-center">
          <div className="space-y-8">
            <h1 className="text-6xl font-bold text-white mb-4">
              ...
              <span className="block text-pink-300 mt-2">M ❤️</span>
            </h1>
